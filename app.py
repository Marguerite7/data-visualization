...
def api():
  ...
  nodes = [dict(id=r[0], group=r[1], year=r[3], label=r[4], duration=r[5], plateform=r[6], continent=r[7], rating=r[2], link=r[9], size=r[10]) for r in csv.reader(open('data/nodes.csv', encoding='utf8'))][1:]
